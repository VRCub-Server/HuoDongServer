(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_15871a42._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$event$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/event-utils.ts [app-client] (ecmascript)"); // Changed import location
;
;
;
;
        ...
        "ProfilePage.useEffect": ()=>{
            async function fetchProfile() {
                ...
                if (debugUserId) {
                    setIsDebugView(true);
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(debugUserId);
                        if (data) {
                            setProfileData(data);
                        } else {
                    ...
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(sessionUser.id);
                        if (data) {
                            setProfileData(data);
                        } else {
                            setError('无法加载您的个人资料。');
...
_s(ProfilePage, "umkLvX+SZKV7E+eN3boV4tO9zr0=", false, function() {
    return [
...
//# sourceMappingURL=src_15871a42._.js.map