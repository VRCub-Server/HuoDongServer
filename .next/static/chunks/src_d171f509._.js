(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d171f509._.js", {
...
function ManageEventsPage() {
    ...
    const fetchAdminPageData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ManageEventsPage.useCallback[fetchAdminPageData]": async ()=>{
            setIsLoadingUser(true);
            startLoading();
            let user = null;
            try {
                user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSessionUser"])();
                setCurrentUser(user);
                if (!user || user.op !== 1) {
                ...
                if ("object" !== 'undefined' && window.location.pathname.startsWith('/admin/manage-events')) {
                    stopLoading();
                }
            }
...
_s(ManageEventsPage, "KCz8v+2UzdQZ1XJHKJmvk+qdqow=", false, function() {
    return [
...
//# sourceMappingURL=src_d171f509._.js.map