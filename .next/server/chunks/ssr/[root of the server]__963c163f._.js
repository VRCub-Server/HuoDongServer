...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/date-fns/parseISO.mjs [app-rsc] (ecmascript)"); // Removed isPast, isEqual, isFuture as they are used in getEventStatus
;
;
;
...
async function checkInUser(userId, eventId) {
    ...
    // Using parseISO for event.date, assuming getEventStatus is now external and this file might need direct date parsing if used internally for status logic
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ login(prevState, formData) {
    ...
    // const captchaToken = formData.get('captchaToken'); // Assuming captcha token is passed
    // if (!captchaToken || !(await verifyCaptcha(captchaToken))) { // verifyCaptcha would be an async function
    //   return { message: '人机验证失败，请重试。' };
    // }
    if (!minecraftUsername) {
        return {
            message: 'Minecraft 用户名是必填项。'
        };
    }
    ...
    if (user) {
        // user.id is considered the "正版帐户Id"
        ...
        return {
            message: '无效的 Minecraft 用户名或用户未在系统中注册。'
        };
    }
}
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getSessionUser() {
    ...
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUserById"])(userId); // Fetches user by their "正版帐户Id"
    } catch (error) {
...
const CreateEventSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    ...
    cdKey: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(4, "激活码至少需要4个字符。").max(20),
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ createEventAction(prevState, formData) {
    ...
    let newEventId;
    try {
        // adminPassword is part of validatedFields.data and used in schema validation
        // We pass the rest of the data to apiCreateEvent
        const { adminPassword, ...eventDataForApi } = validatedFields.data;
        const newEvent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createEvent"])(eventDataForApi, user.id // organizerId is the "正版帐户Id" of the logged-in user
        );
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "由 Firebase Studio 提供的《我的世界》活动平台。"
                }, void 0, false, {
                    fileName: "[project]/src/components/footer.tsx",
                    lineNumber: 6,
                    columnNumber: 9
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$toaster$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/toaster.tsx [app-rsc] (ecmascript)"); // Shadcn toaster
;
;
;
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__963c163f._.js.map