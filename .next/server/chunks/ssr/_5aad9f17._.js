...
function SubmitButton() {
    ...
    // stopLoading will be handled by the form action's finally or LoadingProgressBar on redirect
    }, [
        pending,
        startLoading
    ]);
...
function CreateEventPage() {
    ...
    const [state, dispatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useActionState"])(async (prevState, formData)=>{
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createEventAction"])(prevState, formData);
        if (result && (result.errors || result.message && !result.success)) {
            stopLoading();
        }
        // If successful, createEventAction handles redirect, which will trigger stopLoading in LoadingProgressBar
        return result;
    }, initialState);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function checkUserAuth() {
            ...
            try {
                ...
                setCurrentUser(user);
            // Further permission checks (like user.op === 1) are handled by render logic below
            } catch (error) {
                console.error("Error checking user auth for create event:", error);
            // Potentially set an error state to display to the user
            } finally{
                setIsCheckingAuth(false);
                stopLoading(); // Always stop loading after auth check finishes or if redirecting
            }
        }
        checkUserAuth();
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        router
    ]); // Removed startLoading, stopLoading from deps as they are stable and cause issues here
    ...
    if (!currentUser) {
        ...
        // but as a fallback or if redirect fails client-side before navigation.
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_5aad9f17._.js.map