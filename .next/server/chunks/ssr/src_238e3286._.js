...
function ManageEventsPage() {
    ...
    const fetchAdminPageData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        setIsLoadingUser(true);
        startLoading();
        let user = null;
        try {
            user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSessionUser"])();
            setCurrentUser(user);
            if (!user || user.op !== 1) {
                // Non-admins are handled in the render logic or redirect below
                if (!user) router.push('/login?redirect=/admin/manage-events');
                return;
            }
            ...
            // stopLoading will be called by LoadingProgressBar if a redirect happens for non-admin/non-logged-in users.
            // If staying on page, stopLoading here.
            if ("undefined" !== 'undefined' && window.location.pathname.startsWith('/admin/manage-events')) {
...
//# sourceMappingURL=src_238e3286._.js.map